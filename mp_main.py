...
class SchedulerApp: 
    ...
    def create_widgets(self): 
        ...
        # Process entry 
        ttk.Label(self.master, text="Processes (Process ID, Priority, Burst Time):").grid(row=0, column=0, 
sticky=tk.W, pady=5) 
        ...
        # Run button 
        ttk.Button(self.master, text="Run Scheduler", command=self.run_scheduler).grid(row=4, column=0, 
